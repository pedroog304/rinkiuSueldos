...
// Recorrer el resultado de la consulta y agregar los ID de empleados al array
while ($row = $result->fetch_assoc()) {
    $empleados_registrados[] = $row['no_empleado'];
}
$conn->close();

// Crear una lista de todos los ID de empleados posibles (supongamos que va desde el 1 al 100)
$empleados_totales = range(1, 500);

// Filtrar los ID de empleados que no están registrados
